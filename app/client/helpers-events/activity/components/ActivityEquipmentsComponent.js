...
class ActivityEquipmentsComponent extends BlazeComponent{
    template() {
    ...
    equipmentWithAQuantity() {
        return _.reject(this.activityData().equipments, function (equipment) {
    ...
    autoformNameForQuantity() {
        var equipments = this.activityData().equipments;
