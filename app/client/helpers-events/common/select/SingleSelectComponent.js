...
export class SingleSelectComponent extends SelectComponent {
        ...
        checkItemPath() {
            ...
            if (!item)
                throw new Meteor.Error(400,`${this.constructor.name} : could not find ${this.updateItemId} in collection ${this.updateCollection}`);
